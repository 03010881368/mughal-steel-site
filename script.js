...
products.forEach(product => {
    ...
    productDiv.innerHTML = `
        ...
        <a href="https://wa.me/923010000000?text=I'm%20interested%20in%20your%20${encodeURIComponent(product.name)}" class="whatsapp-button" target="_blank">Order on WhatsApp</a>
    `;
